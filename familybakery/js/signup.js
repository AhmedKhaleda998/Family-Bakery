...
userFirstName.addEventListener("change", validationFirstName);
userLastName.addEventListener("change", validationLastName);
userEmail.addEventListener("change", validationEmail);
userPass.addEventListener("change", validationPass);

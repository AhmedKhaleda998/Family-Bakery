...
reserverFirstName.addEventListener("change", validationFirstName);
reserverLastName.addEventListener("change", validationLastName);
reserverEmail.addEventListener("change", validationEmail);
reserveGuestsNum.addEventListener("change", validationGuests);
reserverPhone.addEventListener("change", validationPhone);
